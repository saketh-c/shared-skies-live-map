...
[OK] jullum2021: Verified against the arXiv abstract page on 2026-08-09. Title "groupShapley: Efficient prediction explanation with Shapley values for feature groups", authors Martin Jullum, Annabelle Redelmeier, Kjersti Aas, first submitted June 23, 2021, primary class stat.ML, arXiv:2106.12228. All fields in the bib entry match. The paper remains an arXiv preprint (no journal version found), so the @misc/arXiv form is correct.
  evidence: https://arxiv.org/abs/2106.12228

## Full re-verification pass (2026-08-09, v2 package)

All 16 entries in references.bib were independently re-checked against live
authoritative sources on 2026-08-09: Crossref API records for the ten DOI
journal/proceedings entries (barkjohn2021, breiman2001, brey2018, chen2016,
choubin2025, desouza2021, lundberg2020, meyer2022, peuch2022, and the since
removed inness2019), DataCite/Zenodo for zippenfenig, DBLP for the three
NeurIPS entries (lundberg2017 pages 4765-4774, ke2017 pages 3146-3154,
prokhorenkova2018 pages 6639-6649), the Federal Register API for epa2024naaqs
(confirmed: Rule, 89 FR 16202, published 2024-03-06, effective 2024-05-06),
a live HTTP 200 check of the archived EJScreen tech-doc URL for ejscreen, and
the arXiv abstract page for jullum2021. Every field matched; zero corrections
were required. Entries inness2019 and ruminski2006 were dropped from the bib
upstream and are no longer cited.
