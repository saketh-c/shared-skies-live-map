...
seven concept groups make predictions readable in physical units. The
...
(CI $[0.105, 0.115]$), and $+0.097$ over all 431 heavy-tier rows
(CI $[0.088, 0.113]$; the heavy rows fall on only 31 days). Heavy-tier
attribution shows no increase over medium (difference CI
$[-0.004, 0.023]$~\ugm{}), and the whole tier range is negligible against
...
(c) Traffic proximity is inert until roughly the 85th percentile,
...
36.1~\ugm{}, and the regional signal group contributed $+24.8$~\ugm{} of
that on average. The smoke tier's largest contribution anywhere in the
state was $+0.31$~\ugm{}. On April 3, 2024 (statewide mean 1.03~\ugm{}), the
...
$+1.25$~\ugm{}, with individual sensors up to $+9.3$~\ugm{}. Persistently
...
exist. Whether demographic indicators belong in a served public model's
inputs at all is a question this paper surfaces rather than settles; the
explanation layer makes it inspectable.
...
tier, inverts proximity features at the urban extreme, and structurally
