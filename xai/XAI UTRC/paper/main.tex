...
for 11.1\% of blended attribution \cite{ejscreen}; all eight were removed before this
...
frozen sensor-grouped folds with the blend held fixed, the cost of dropping
the four demographic features is $\Delta R^2 = 0.0022$ (95\% CI
$[-0.0031,+0.0083]$) and of dropping all eight is $-0.0005$
($[-0.0070,+0.0066]$) --- negative, i.e. the smaller model scored
